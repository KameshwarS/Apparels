...
import com.example.kelineyt.fragments.loginRegister.IntroductionFragment
...
class IntroductionViewModel @Inject constructor(
    ...
    init {
        ...
        if(user!=null){
            viewModelScope.launch { _navigate.emit(SHOPPING_ACTIVTY) }
        }
